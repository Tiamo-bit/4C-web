...
// .wrangler/tmp/pages-239pl4/functionsWorker-0.9585923605068221.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
var MAX_USER_MESSAGE_LENGTH = 1e3;
var MAX_CONTEXT_FIELD_LENGTH = 2400;
var MAX_MESSAGES = 10;
...
function parseMessages(value) {
  ...
  const messages = value.filter((item) => isRecord(item)).map((item) => ({
    role: item.role,
...
function parseContext(value) {
  ...
  if (typeof provinceName !== "string" || typeof archName !== "string" || typeof card !== "string" || !Array.isArray(sections)) {
    return null;
  }
  const parsedSections = sections.filter((section) => isRecord(section)).map((section) => ({
    title: typeof section.title === "string" ? section.title : "",
    body: typeof section.body === "string" ? section.body : ""
  })).filter((section) => section.title.trim() && section.body.trim()).slice(0, 6).map((section) => ({
...
__name2(parseContext, "parseContext");
function buildSystemPrompt(context) {
  const sectionText = context.sections.map((section) => `\u3010${section.title}\u3011${section.body}`).join("\n");
  return [
...
__name(callOpenAICompatibleProvider, "callOpenAICompatibleProvider");
__name2(callOpenAICompatibleProvider, "callOpenAICompatibleProvider");
...
// .wrangler/tmp/bundle-XvFWS6/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-XvFWS6/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9585923605068221.js.map
